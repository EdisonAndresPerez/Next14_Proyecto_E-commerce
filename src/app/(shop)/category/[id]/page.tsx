...
const genreLabels: Record<string, { title: string; subtitle: string }> = {
  ...
  'adventure': { title: 'Juegos de Aventura', subtitle: 'Explora mundos increíbles' },
  ...
  'ps5': { title: 'Juegos de PS5', subtitle: 'La nueva generación de PlayStation' },
  'ps2': { title: 'Clásicos de PS2', subtitle: 'Los mejores juegos retro de PlayStation 2' },
  'ps1': { title: 'Clásicos de PS1', subtitle: 'Las joyas de la PlayStation original' },
};
...
export default function CategoryPage({ params }: Readonly<Props>) {
  ...
  const products = seedProducts.filter( (product: any) => product.category === id );
